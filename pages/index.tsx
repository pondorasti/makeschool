...
const concentrations: IConcentration[] = [
  {
    ...
    courses: [
      {
        name: "FEW 1.1",
        description: "Foundation Web",
        instructor: "Mitchell",
        link: "/courses/FEW-1.1",
      },
      {
        name: "FEW 1.2",
        description: "Foundation JavaScript",
        instructor: "Mitchell",
      ...
      {
        name: "FEW 2.2",
        description: "Advanced CSS and Visual Design",
        instructor: "Mitchell",
  ...
  },
  {
    ...
    courses: [
      ...
      {
        name: "BEW 2.2",
        description: "Docker, DevOps, & Deployments",
        instructor: "Dani",
      ...
      {
        name: "BEW 2.5",
        description: "Go - Patterns & Practices in Strongly Typed Languages",
        instructor: "Dani",
