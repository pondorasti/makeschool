...
extern uint16_t invader1BitmapDown [];
extern uint16_t invader1BitmapUp   []; 
...
//            myGLCD.fillRect(-22 + xPos * 14, -18 + yPos * 14, -10 + (xPos + 2) * 14, -6 + yPos * 14);
            ...
            int xStart = -22 + xPos * 14;
            int yStart = -18 + yPos * 14;
          // call lowest level graphics primitives
            myGLCD.setAddrWindow(xStart, yStart, xStart + 32, yStart + 23);
            if (xPos & 1)
        ...
        void EraseAlien (void) {
            ...
            myGLCD.fillRect(xStart, yStart, xStart + 32, yStart + 23);
       };
            ...
            if (WeaponLive) {
                ...
                for (int x = 0; x < INVADER_ROWS * INVADER_COLUMNS; x++) {
                    ...
                    if (yPos == alienY)
                        ...
                        {
                            EraseWeapon ();
                            int xStart = -22 + alienX * 14;
                            int yStart = -18 + alienY * 14;             
                            myGLCD.setColor(0, 0, 0);
                            myGLCD.fillRect(xStart, yStart, xStart + 32, yStart + 23);
