    ...
    <>
      {concentrations.map((concentration) => (
        <div key={concentration.name} className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 tracking-tight sm:text-3xl mb-3">{concentration.name}</h3>
          <p className="text-gray-500 mb-5">{concentration.description}</p>
